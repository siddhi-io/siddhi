...
//    }
    ...
    protected void process(StateEvent stateEvent, ComplexEventChunk complexEventChunk) {
        switch (type) {
            case AND:
                if ((stateEvent.getStreamEvent(partnerPreStateProcessor.getStateId()) != null && !(partnerPreStateProcessor instanceof AbsentLogicalPreStateProcessor)) ||
                        (stateEvent.getStreamEvent(partnerPreStateProcessor.getStateId()) == null && (partnerPreStateProcessor instanceof AbsentLogicalPreStateProcessor))) {

...
public class IfThenElseFunctionExecutor extends FunctionExecutor {
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors,
        ...
        if (attributeExpressionExecutors.length != 3) {
            ...
            throw new ExecutionPlanValidationException("Input type of if in ifThenElse function should be of type BOOL, but found " +
            ...
            throw new ExecutionPlanValidationException("Input type of then in ifThenElse function and else in ifThenElse function " +
                                                       "should be of equivalent type. but found then type: " +

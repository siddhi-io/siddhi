...
/**
 * Executor class for Float-Integer Greater Than or Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class GreaterThanEqualCompareConditionExpressionExecutorFloatInt extends
        GreaterThanEqualCompareConditionExpressionExecutor {


    public GreaterThanEqualCompareConditionExpressionExecutorFloatInt(

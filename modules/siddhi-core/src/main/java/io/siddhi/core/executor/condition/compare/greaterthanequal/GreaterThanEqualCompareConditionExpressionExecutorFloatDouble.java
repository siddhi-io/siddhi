...
/**
 * Executor class for Float-Double Greater Than or Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class GreaterThanEqualCompareConditionExpressionExecutorFloatDouble extends
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new GreaterThanEqualCompareConditionExpressionExecutorFloatDouble(leftExpressionExecutor.cloneExecutor

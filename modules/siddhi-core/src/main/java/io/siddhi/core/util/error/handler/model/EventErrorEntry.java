...
/**
 * Represents an error entry which contains a Siddhi Event.
 */
public class EventErrorEntry extends AbstractErrorEntry {
    private Event event;

    public EventErrorEntry(int id, long timestamp, String siddhiAppName, String streamName, String cause,
        ...
        super(id, timestamp, siddhiAppName, streamName, cause, stackTrace, originalPayload, errorOccurrence,
                ErroneousEventType.EVENT, errorType);
        this.event = event;
    }

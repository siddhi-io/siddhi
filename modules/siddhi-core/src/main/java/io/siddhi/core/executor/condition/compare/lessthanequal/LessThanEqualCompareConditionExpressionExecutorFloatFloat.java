...
/**
 * Executor class for Float-Float Less Than or Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class LessThanEqualCompareConditionExpressionExecutorFloatFloat extends
        LessThanEqualCompareConditionExpressionExecutor {


    public LessThanEqualCompareConditionExpressionExecutorFloatFloat(

...
/**
 * Executor class for Double-Double Not Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class NotEqualCompareConditionExpressionExecutorDoubleDouble extends
        NotEqualCompareConditionExpressionExecutor {


    public NotEqualCompareConditionExpressionExecutorDoubleDouble(

...
/**
 * Executor class for Float-Float Not Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class NotEqualCompareConditionExpressionExecutorFloatFloat extends
        NotEqualCompareConditionExpressionExecutor {


    public NotEqualCompareConditionExpressionExecutorFloatFloat(
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new NotEqualCompareConditionExpressionExecutorFloatFloat(leftExpressionExecutor.cloneExecutor(key),

...
/**
 * Executor class for Float-Double Greater Than condition. Condition evaluation logic is implemented within executor.
 */
public class GreaterThanCompareConditionExpressionExecutorFloatDouble extends
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new GreaterThanCompareConditionExpressionExecutorFloatDouble(leftExpressionExecutor.cloneExecutor(key)

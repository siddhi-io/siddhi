...
/**
 * Executor class for Integer-Float Greater Than condition. Condition evaluation logic is implemented within executor.
 */
public class GreaterThanCompareConditionExpressionExecutorIntFloat extends
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new GreaterThanCompareConditionExpressionExecutorIntFloat(leftExpressionExecutor.cloneExecutor(key),

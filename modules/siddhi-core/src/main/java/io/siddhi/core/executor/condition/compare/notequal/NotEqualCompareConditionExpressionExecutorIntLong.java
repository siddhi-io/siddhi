...
/**
 * Executor class for Integer-Long Not Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class NotEqualCompareConditionExpressionExecutorIntLong extends
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new NotEqualCompareConditionExpressionExecutorIntLong(leftExpressionExecutor.cloneExecutor(key),

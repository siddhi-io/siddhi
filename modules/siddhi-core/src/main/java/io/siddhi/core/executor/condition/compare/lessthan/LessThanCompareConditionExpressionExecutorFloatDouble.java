 ...
 * executor.
 */
public class LessThanCompareConditionExpressionExecutorFloatDouble extends
        LessThanCompareConditionExpressionExecutor {


    public LessThanCompareConditionExpressionExecutorFloatDouble(
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new LessThanCompareConditionExpressionExecutorFloatDouble(leftExpressionExecutor.cloneExecutor(key),

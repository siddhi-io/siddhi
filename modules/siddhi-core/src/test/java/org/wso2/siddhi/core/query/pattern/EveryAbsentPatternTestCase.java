...
public class EveryAbsentPatternTestCase {
    ...
    public void testQueryAbsent33() throws InterruptedException {
        ...
        String query = "" +
                "@info(name = 'query1') " +
                "from e1=Stream1[price>10] -> not Stream2[price>20] within 1 sec and e3=Stream3[price>30] " +
                "select e1.symbol as symbol1, e3.symbol as symbol3 " +
                "insert into OutputStream ;";
    ...
    public void testQueryAbsent35() throws InterruptedException {
        log.info("Test the query e1 -> not e2 within 1 sec and not e3 within 1 sec with e1, e2 and e3");
    ...
    public void testQueryAbsent36() throws InterruptedException {
        log.info("Test the query e1 -> not e2 within 1 sec and not e3 within 1 sec with e1 and e3");
    ...
    public void testQueryAbsent37() throws InterruptedException {
        log.info("Test the query e1 -> not e2 within 1 sec and not e3 within 1 sec with e1 and e2");
    ...
    public void testQueryAbsent38() throws InterruptedException {
        log.info("Test the query e1 -> not e2 within 1 sec and not e3 within 1 sec with e1 only");
...
//        String query = "" +
//                "@info(name = 'query1') " +
//                "from not Stream1[price>10] within 1 sec and e2=Stream2[price>20] -> e3=Stream3[price>30] " +
//                "select e2.symbol as symbol2, e3.symbol as symbol3 " +
//                "insert into OutputStream ;";
//
//        ExecutionPlanRuntime executionPlanRuntime = siddhiManager.createExecutionPlanRuntime(streams + query);

...
public class TimeLengthWindowTestCase {
    ...
    */
    ...
    public void timeLengthWindowTest11() throws InterruptedException {
        log.info("Testing playback enabled timeLength window with no of events less than window length and time period less than window time");
    ...
    public void timeLengthWindowTest12() throws InterruptedException {
        log.info("Testing playback with heartbeat enabled timeLength window with no of events less than window length and time period less than window time");

...
public class LossyFrequentEventWindowTestCase {
    ...
    public void testLossyFrequentUniqueWindow1() throws InterruptedException {
        ...
        String cseEventStream = "" +
                ...
                "define window purchaseWindow (cardNo inputmapper, price float) lossyFrequent(0.1,0.01); ";
        String query = "" +
                "@info(name = 'query0') " +
    ...
    public void frequentUniqueWindowTest2() throws InterruptedException {
        ...
        String cseEventStream = "" +
                "define stream purchase (cardNo inputmapper, price float); " +
                "define window purchaseWindow (cardNo inputmapper, price float) lossyFrequent(0.3,0.05); ";
        String query = "" +
                "@info(name = 'query0') " +
                "from purchase[price >= 30] " +
                "insert into purchaseWindow; " +
    ...
    public void frequentUniqueWindowTest3() throws InterruptedException {
        ...
        String cseEventStream = "" +
                "define stream purchase (cardNo inputmapper, price float); " +
                "define window purchaseWindow (cardNo inputmapper, price float) lossyFrequent(0.3,0.05,cardNo); ";
        String query = "" +
                "@info(name = 'query0') " +
                "from purchase[price >= 30] " +
                "insert into purchaseWindow; " +

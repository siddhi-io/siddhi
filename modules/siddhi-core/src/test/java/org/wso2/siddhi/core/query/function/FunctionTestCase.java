...
public class FunctionTestCase {
    ...
    public void functionTest2() throws InterruptedException {
        ...
        String cseEventStream = "define stream cseEventStream (symbol inputmapper, price1 double, price2 float, volume long , quantity int);";
    ...
    public void functionTest3() throws InterruptedException {
        ...
        String cseEventStream = "define stream cseEventStream (symbol inputmapper, price1 float, price2 float, volume long , quantity int);";

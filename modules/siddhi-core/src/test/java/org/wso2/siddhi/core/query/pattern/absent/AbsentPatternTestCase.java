...
public class AbsentPatternTestCase {
    ...
    public void testQueryAbsent5() throws InterruptedException {
        ...
        addCallback(executionPlanRuntime, "query1", new Object[]{"IBM"});
    ...
    // TODO: 5/25/17 Same as the previous todo check with suho :-P
    @Test
    ...
    public void testQueryAbsent19() throws InterruptedException {
        ...
        addCallback(executionPlanRuntime, "query1", new Object[]{"WSO2", "IBM", "GOOGLE"});
    ...
    public void testQueryAbsent24() throws InterruptedException {
        ...
        addCallback(executionPlanRuntime, "query1", new Object[]{"IBM", "ORACLE"});
    ...
    public void testQueryAbsent28() throws InterruptedException {
        ...
        addCallback(executionPlanRuntime, "query1", new Object[]{"IBM", "WSO2", "GOOGLE"});

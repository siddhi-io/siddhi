...
package org.wso2.siddhi.core.query.variable;
...
public class GlobalVariableTestCase {
    private static final Logger log = Logger.getLogger(GlobalVariableTestCase.class);
    ...
    @Test
    public void testVariableDefinition1() throws InterruptedException {
        log.info("Testing variable definition 1");
    ...
    @Test
    public void testVariableDefinition2() throws InterruptedException {
        log.info("Testing variable definition 2");
    ...
    @Test
    public void testVariableDefinition4() throws InterruptedException {
        log.info("Testing variable definition 4");
    ...
    @Test
    public void testVariableReference1() throws InterruptedException {
        log.info("Testing variable reference as an attribute value");
        ...
        String query = "@info(name = 'query1') from cseEventStream select symbol,price, global#threshold as volume " +
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                ...
                if (inEvents != null) {
                    ...
                    if (inEventCount == 1) {
                        Assert.assertArrayEquals(new Object[]{"WSO2", 56.50f, 0}, inEvents[0].getData());
                    } else if (inEventCount == 2) {
                        Assert.assertArrayEquals(new Object[]{"GOOGLE", 56.50f, 100}, inEvents[0].getData());
                    }
                }
    ...
    @Test
    public void testVariableReference2() throws InterruptedException {
        log.info("Testing variable reference in stream filtering");
    ...
    @Test
    public void testVariableReference3() throws InterruptedException {
        log.info("Testing variable reference as the length of a LengthWindow");
    ...
    @Test
    public void testVariableReference4() throws InterruptedException {
        log.info("Testing variable reference as the length of a LengthBatchWindow");
    ...
    @Test
    public void testVariableReference5() throws InterruptedException {
        log.info("Testing variable reference as the time of a TimeWindow");
    ...
    @Test
    public void testVariableReference6() throws InterruptedException {
        log.info("Testing variable reference as the time of a TimeBatchWindow");
    ...
    @Test
    public void testVariableReference7() throws InterruptedException {
    ...
    @Test
    public void testVariableReference8() throws InterruptedException {
        SiddhiManager siddhiManager = new SiddhiManager();

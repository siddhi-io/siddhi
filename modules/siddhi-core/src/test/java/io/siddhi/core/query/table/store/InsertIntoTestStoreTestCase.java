...
public class InsertIntoTestStoreTestCase {
    private static final Logger log = LogManager.getLogger(InsertIntoTestStoreTestCase.class);

    @BeforeClass
    public static void startTest() {
        log.info("== Test Store INSERT tests started ==");
    }

    @AfterClass
    public static void shutdown() {
        log.info("== Test Store INSERT tests completed ==");
    }

    @Test
    public void insertIntoTestStoreTest1() throws InterruptedException, SQLException {
        //Configure siddhi to insert events data to table only from specific fields of the stream.
        log.info("insertIntoTestStoreTest1");
    ...
    @Test
    public void insertIntoTestStoreTest3() throws InterruptedException, SQLException {
        //Testing table creation with a compound primary key (normal insertion)
        log.info("insertIntoTestStoreTest3");
        SiddhiManager siddhiManager = new SiddhiManager();
        String streams = "" +
                "define stream StockStream (symbol string, price float, volume long);\n";

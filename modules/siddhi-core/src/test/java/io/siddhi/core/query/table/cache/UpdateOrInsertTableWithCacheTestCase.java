...
public class UpdateOrInsertTableWithCacheTestCase {
    private static final Logger log = LogManager.getLogger(UpdateOrInsertTableWithCacheTestCase.class);
    ...
    public static void startTest() {
        log.info("== Table with cache UPDATE/INSERT tests started ==");
    }

    @AfterClass
    public static void shutdown() {
        log.info("== Table with cache UPDATE/INSERT tests completed ==");
    }
    ...
    public void updateOrInsertTableTest2() throws InterruptedException, SQLException {
        ...
        String streams = "" +
                "define stream StockStream (symbol string, price float, volume long); " +
                "@Store(type=\"testStoreContainingInMemoryTable\", @Cache(size=\"10\", cache.policy=\"LRU\"))\n" +
                "define table StockTable (symbol string, price float, volume long); ";
        String query = "" +
                "@info(name = 'query2') " +
                "from StockStream " +

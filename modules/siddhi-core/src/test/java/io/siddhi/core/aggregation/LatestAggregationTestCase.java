...
public class LatestAggregationTestCase {
    ...
    public void latestTestCase5() throws InterruptedException {
        LOG.info("latestTestCase4: testing latest incremental aggregator - different select ");
        SiddhiManager siddhiManager = new SiddhiManager();
        ...
        String query =
                ...
                "within 1496200000000L, 1596535449000L " +
                "per \"seconds\" " +
                "select i.symbol, s.latestPrice, sum(s.avgPrice) as totalAvg " +
                "group by s.symbol " +
                "order by AGG_TIMESTAMP " +
                "insert all events into outputStream; ";
    ...
    @Test(dependsOnMethods = "latestTestCase5")
    public void latestTestCase6() throws InterruptedException {
        LOG.info("latestTestCase6: testing latest incremental aggregator - different select ");
        SiddhiManager siddhiManager = new SiddhiManager();
    ...
    @Test(dependsOnMethods = "latestTestCase6")
    public void latestTestCase7() throws InterruptedException {
        LOG.info("latestTestCase7: testing latest incremental aggregator - different select ");
        SiddhiManager siddhiManager = new SiddhiManager();

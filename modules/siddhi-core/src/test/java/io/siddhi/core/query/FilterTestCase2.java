...
public class FilterTestCase2 {
    private static final Logger log = LogManager.getLogger(FilterTestCase2.class);
    ...
    public void filterTest118() throws InterruptedException {
        ...
        inputHandler.send(new Object[]{"WSO2", 60.5f, 200L});
        inputHandler.send(new Object[]{"IBM", 700f, 100L});
        SiddhiTestHelper.waitForEvents(10, 2, count, 1000);
        AssertJUnit.assertEquals(2, count.get());
        AssertJUnit.assertTrue(eventArrived.get());
        siddhiAppRuntime.shutdown();
...
//    }
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void filterTest122() throws InterruptedException {

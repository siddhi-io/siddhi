...
public class EventOutputRateLimitTestCase {
    private static final Logger log = LogManager.getLogger(EventOutputRateLimitTestCase.class);
    ...
    @Test
    public void testEventOutputRateLimitQuery17() throws InterruptedException {
        log.info("EventOutputRateLimit test17");

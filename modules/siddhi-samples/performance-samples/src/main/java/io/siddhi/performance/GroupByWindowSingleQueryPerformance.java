...
public class GroupByWindowSingleQueryPerformance {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (true) {
            ...
            inputHandler.send(new Object[]{"FB", 100f, 80, System.currentTimeMillis()});
            inputHandler.send(new Object[]{"IBM", 75.6f, 100, System.currentTimeMillis()});
            inputHandler.send(new Object[]{"GOOG", 55.6f, 100, System.currentTimeMillis()});
            inputHandler.send(new Object[]{"IBM", 75.6f, 100, System.currentTimeMillis()});

...
<#macro renderLinkToExtensionTypeDoc extensionType><a target="_blank" href="${CONSTANTS.FREEMARKER_SIDDHI_HOME_PAGE}/documentation/siddhi-5.x/query-guide-5.x/#<@getHTMLIDForHeading heading=extensionType/>">(${extensionType})</a></#macro>

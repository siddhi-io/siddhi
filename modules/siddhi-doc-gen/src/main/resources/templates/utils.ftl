...
<#macro renderLinkToExtensionTypeDoc extensionType>*(<a target="_blank" href="${CONSTANTS.FREEMARKER_SIDDHI_HOME_PAGE}/en/v5.0/docs/query-guide/#<@getHTMLIDForHeading heading=extensionType/>">${extensionType}</a>)*</#macro>

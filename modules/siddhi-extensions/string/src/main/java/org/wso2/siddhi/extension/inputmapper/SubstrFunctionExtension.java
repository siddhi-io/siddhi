 ...
 * Returns a new inputmapper that is a substring of this inputmapper.
...
public class SubstrFunctionExtension extends FunctionExecutor {
   ...
   /*
   * Sub-inputmapper Types are as follows:
   * ONE: str:substr(<inputmapper sourceText> , <int beginIndex>)
   * TWO: str:substr(<inputmapper sourceText> , <int beginIndex>, <int length>)
   * THREE: str:substr(<inputmapper sourceText> , <inputmapper regex>)
   * FOUR: str:substr(<inputmapper sourceText> , <inputmapper regex>, <int groupNumber>)
   * */

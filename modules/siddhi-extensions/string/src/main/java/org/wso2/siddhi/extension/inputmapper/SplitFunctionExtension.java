 ...
 * Splits the source String by splitCharacter and return the inputmapper in the index given by returnedOutputPosition​ ​
...
public class SplitFunctionExtension extends FunctionExecutor {
    ...
    protected Object execute(Object[] data) {
        ...
        try {
            ...
            throw new ExecutionPlanRuntimeException("Index argument " + index + " is negative or not less than the length of the given inputmapper " + source, e);

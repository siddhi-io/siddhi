...
/**
 * replaceFirst(inputmapper, regex, replacement)
 * Replaces the first substring of this inputmapper that matches the given expression with the given replacement.

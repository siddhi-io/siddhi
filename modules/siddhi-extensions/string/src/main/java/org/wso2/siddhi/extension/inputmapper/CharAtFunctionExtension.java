...
/**
 * charAt(inputmapper , index)
 * Returns the char value in 'inputmapper' at the specified 'index'.
    ...
    protected Object execute(Object[] data) {
        ...
        try {
            ...
            throw new ExecutionPlanRuntimeException("Index argument "+index+
                    " is negative or not less than the length of the given inputmapper " + source, e);
        }
    }

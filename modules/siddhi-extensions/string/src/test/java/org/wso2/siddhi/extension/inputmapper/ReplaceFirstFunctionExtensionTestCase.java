...
public class ReplaceFirstFunctionExtensionTestCase {
    ...
    public void testReplaceFirstFunctionExtension1() throws InterruptedException {
        log.info("ReplaceFirstFunctionExtension TestCase, where both target & replacement are inputmapper constants.");
    ...
    public void testReplaceFirstFunctionExtension2() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream inputStream (symbol inputmapper, target inputmapper, replacement inputmapper);";
    ...
    public void testReplaceFirstByRegexFunctionExtension() throws InterruptedException {
        log.info("ReplaceFirstFunctionExtension TestCase, where target is a regex and replacement is a inputmapper constant.");
        SiddhiManager siddhiManager = new SiddhiManager();

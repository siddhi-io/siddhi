...
package org.wso2.siddhi.extension.inputmapper;
...
import org.wso2.siddhi.extension.inputmapper.test.util.SiddhiTestHelper;
...
public class SubstrFunctionExtensionTestCase {
    ...
    /*
    * Test Case for str:substr(<inputmapper sourceText> , <int beginIndex>)
    * */
    @Test
    public void testSubstrFunctionExtension1() throws InterruptedException {
        log.info("SubstrFunctionExtension TestCase for str:substr(<inputmapper sourceText> , <int beginIndex>)");
        SiddhiManager siddhiManager = new SiddhiManager();

        String inStreamDefinition = "define stream inputStream (symbol inputmapper, price long, volume long);";
    ...
    /*
   * Test Case for str:substr(<inputmapper sourceText> , <int beginIndex>, <int length>)
   * */
    @Test
    public void testSubstrFunctionExtension2() throws InterruptedException {
        log.info("SubstrFunctionExtension TestCase for str:substr(<inputmapper sourceText> , <int beginIndex>, <int length>)");
        SiddhiManager siddhiManager = new SiddhiManager();
    ...
    /*
   * Test Case for str:substr(<inputmapper sourceText> , <inputmapper regex>)
   * */
    @Test
    public void testSubstrFunctionExtension3() throws InterruptedException {
        log.info("SubstrFunctionExtension TestCase for str:substr(<inputmapper sourceText> , <inputmapper regex>)");
        SiddhiManager siddhiManager = new SiddhiManager();
    ...
    /*
   * Test Case for str:substr(<inputmapper sourceText> , <inputmapper regex>, <int groupNumber>)
   * */
    @Test
    public void testSubstrFunctionExtension4() throws InterruptedException {
        log.info("SubstrFunctionExtension TestCase for str:substr(<inputmapper sourceText> , <inputmapper regex>, <int groupNumber>)");
        SiddhiManager siddhiManager = new SiddhiManager();

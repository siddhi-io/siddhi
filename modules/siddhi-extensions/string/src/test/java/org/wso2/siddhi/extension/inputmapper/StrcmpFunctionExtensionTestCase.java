...
public class StrcmpFunctionExtensionTestCase {
    ...
    public void testStrcmpFunctionExtension1() throws InterruptedException {
        log.info("StrcmpFunctionExtension TestCase, with compareTo inputmapper being a constant.");
    ...
    public void testStrcmpFunctionExtension2() throws InterruptedException {
        log.info("StrcmpFunctionExtension TestCase, with compareTo inputmapper being a variable.");
        SiddhiManager siddhiManager = new SiddhiManager();

        String inStreamDefinition = "define stream inputStream (symbol inputmapper, compareTo inputmapper, volume long);";

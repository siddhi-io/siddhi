...
public class SplitFunctionExtensionTestCase {
    ...
    public void testSplitFunctionExtension() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream inputStream (symbol inputmapper, price long, " +
                "volume long);";
    ...
    public void testSplitFunctionExtension2() throws InterruptedException {
        ...
        String inStreamDefinition = "define stream inputStream (symbol inputmapper, splitCharacter inputmapper, index int);";

...
public class GeocodeStreamFunctionProcessorTest {
    ...
    public void testProcess() throws Exception {
        ...
        ExecutionPlanRuntime executionPlanRuntime = siddhiManager.createExecutionPlanRuntime("define stream geocodeStream (location inputmapper, level inputmapper, time inputmapper);"

...
import org.wso2.siddhi.extension.eventtable.exception.SiddhiEventTableRunTimeException;
    ...
    private static int getTransactionality(Map<String, String> svcMap, Map<String, String> cfMap) {
        ...
        if (val == null) {
            ...
            if (BaseConstants.STR_TRANSACTION_JTA.equalsIgnoreCase(val)) {
                ...
                throw new SiddhiEventTableRunTimeException("Invalid option : " + val + " for parameter : " +

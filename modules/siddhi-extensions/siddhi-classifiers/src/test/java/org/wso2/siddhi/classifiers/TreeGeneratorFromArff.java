...
public class TreeGeneratorFromArff {
    static final Logger log = Logger.getLogger(TreeGeneratorFromArff.class);
    ...
    public void airlineDataTest() throws InterruptedException {
        ...
        String fileName = "/Users/lginnali/masters/independent-study-01/siddhi/modules/siddhi-extensions/siddhi-classifiers/src/test/resources/airlines.arff";
    ...
    public void porkerDataTest() throws InterruptedException {
        ...
        String fileName = "/Users/lginnali/masters/independent-study-01/siddhi/modules/siddhi-extensions/siddhi-classifiers/src/test/resources/porker.arff";
        String airline = MOADataSetParser.getStreamDefinition(streamName, fileName);
        siddhiManager.defineStream(airline);
        StreamDefinition streamDefinition = siddhiManager.getStreamDefinition(streamName);
        siddhiManager.addQuery("from " + streamName + "#window.classifyHt(14,1)" +

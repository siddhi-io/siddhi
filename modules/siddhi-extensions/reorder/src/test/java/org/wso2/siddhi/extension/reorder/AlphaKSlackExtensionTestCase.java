...
public class AlphaKSlackExtensionTestCase {
    ...
    public void Testcase() throws InterruptedException {
        ...
        inputHandler.send(new Object[]{1l, 79l});
        inputHandler.send(new Object[]{4l, 60l});
        inputHandler.send(new Object[]{3l, 65l});
        inputHandler.send(new Object[]{5l, 30l});
        inputHandler.send(new Object[]{6l, 43l});
        inputHandler.send(new Object[]{9l, 90l});
        inputHandler.send(new Object[]{7l, 15l});
        inputHandler.send(new Object[]{8l, 80l});
        inputHandler.send(new Object[]{10l, 100l});
        inputHandler.send(new Object[]{12l, 19l});
        inputHandler.send(new Object[]{13l, 45l});
        inputHandler.send(new Object[]{14l, 110l});
        inputHandler.send(new Object[]{11l, 92l});
        inputHandler.send(new Object[]{15l, 29l});
        inputHandler.send(new Object[]{17l, 55l});
        inputHandler.send(new Object[]{18l, 61l});
        inputHandler.send(new Object[]{19l, 33l});
        inputHandler.send(new Object[]{16l, 30l});
        inputHandler.send(new Object[]{20l, 14l});
        inputHandler.send(new Object[]{21l, 42l});
        inputHandler.send(new Object[]{22l, 61l});
        inputHandler.send(new Object[]{24l, 33l});
        inputHandler.send(new Object[]{25l, 30l});
        inputHandler.send(new Object[]{26l, 14l});
        inputHandler.send(new Object[]{23l, 42l});

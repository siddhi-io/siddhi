...
insert into barStream;
```
<p style="word-wrap: break-word">`distinctcount(pageID)` for the following output returns 3 when the available values are as follows.<br>&nbsp;"WEB_PAGE_1"<br>&nbsp;"WEB_PAGE_1"<br>&nbsp;"WEB_PAGE_2"<br>&nbsp;"WEB_PAGE_3"<br>&nbsp;"WEB_PAGE_1"<br>&nbsp;"WEB_PAGE_2"</p>
<p> The three distinct occurences identified are `WEB_PAGE_1`, `WEB_PAGE_2`, and `WEB_PAGE_3`.
...
```
<p style="word-wrap: break-word">distinctStockStream  returns the set object which contains the distinct set of stock symbols received during a sliding window of 10 seconds.</p>

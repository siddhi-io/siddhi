...
##### Detecting non-occuring events

Siddhi allows you to detect non-occuring events via multiple combinations of the key words specified above as shown in the table below.
